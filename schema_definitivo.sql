...
CREATE TABLE IF NOT EXISTS store_config (
    ...
    rec_banner_subtitle TEXT DEFAULT '',
    rec_banner_description TEXT DEFAULT 'Aprovecha nuestras ofertas exclusivas en los productos más gustados por nuestra comunidad. ¡No te quedes sin el tuyo!',
    rec_banner_button_text TEXT DEFAULT 'Ver Ofertas',
